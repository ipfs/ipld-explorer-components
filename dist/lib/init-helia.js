...
export default async function initHelia(kuboGatewayOptions) {
  ...
  const libp2p = await createLibp2p({
    ...
    datastore,
    transports: [webRTC(), webRTCDirect(), webTransport(), webSockets(), circuitRelayTransport({
      discoverRelays: 1
    })],
  ...
  // bagaaihraf4oq2kddg6o5ewlu6aol6xab75xkwbgzx2dlot7cdun7iirve23a
