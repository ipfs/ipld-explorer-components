...
const makeBundle = () => {
  ...
  bundle.selectExplorePathFromHash = createSelector('selectRouteInfo', routeInfo => {
   ...
   */
  bundle.reactExploreFetch = createSelector('selectHeliaReady', 'selectExploreIsLoading', 'selectExploreIsWaitingToRetry', 'selectExplorePathFromHash', 'selectExplore', (ipfsReady, isLoading, isWaitingToRetry, explorePathFromHash, obj) => {
  ...
  bundle.doExploreLink = link => _ref2 => {
    let {
      store
    } = _ref2;
    const {
  ...
  bundle.doExploreUserProvidedPath = path => _ref3 => {
    let {
      store
    } = _ref3;
  ...
  bundle.doUploadUserProvidedCar = (file, uploadImage) => async _ref4 => {
    let {
      store
    } = _ref4;
    try {
